...
for pattern, count in patterns.items():
    if count>max:
        ...
        biggest.append(pattern)
        max = count

for pattern, frequency in patterns.items():
    if pattern[5] == pattern[-1]=="L" and pattern[6]==pattern[7]:
        print(pattern)
print(biggest)
print(max)
